...
function Home() {
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        const response = await axios.get('https://inbackend-production.up.railway.app/dashboard');
    ...
    const fetchChartData = async () => {
      try {
        const response = await axios.get('https://inbackend-production.up.railway.app/indemnity-types-per-personnel');
