...
function Sidebar({ openSidebarToggle, OpenSidebar, setActivePage, onLogout }) {
  ...
  useEffect(() => {
    // Fetch admin data
    axios.get('https://inbackend-production.up.railway.app/admin')
      .then(response => {
    ...
    <aside id="sidebar" className={openSidebarToggle ? "sidebar-responsive" : ""}>
      <div className='sidebar-title'>
        <div className='sidebar-brand'>
          {admin.image && (
            <img src={`https://inbackend-production.up.railway.app/uploads/${admin.image}`} alt="photo_admin" className='icon_header' />
          )}
        </div>
