...
function Parametres() {
  ...
  useEffect(() => {
    fetch('https://inbackend-production.up.railway.app/parametres')
  ...
  const handleSubmit = (e) => {
    ...
    if (Object.keys(newErrors).length === 0) {
      const url = modifyId ? `https://inbackend-production.up.railway.app/responsables/${modifyId}` : 'https://inbackend-production.up.railway.app/responsables';
  ...
  const handlePasswordSubmit = (e) => {
    ...
    if (Object.keys(newErrors).length === 0) {
      const url = 'https://inbackend-production.up.railway.app/password'; // Endpoint à définir dans votre backend
